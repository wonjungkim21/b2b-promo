...
버전: v1.0 (2026-08-13)
기반 문서: `docs/2-domain-definition.md` v1.4, `docs/3-usecase.md`, `docs/4-PRD.md` v1.2, `docs/5-user-scenario.md` v1.0
...
3. **도메인 규칙은 한 곳에** — 도메인 정의서 5장(5.1~5.9)의 규칙은 백엔드 서비스 레이어에만 존재한다. 프론트엔드는 이 규칙을 복제하지 않고 서버 응답을 그대로 신뢰하며, 사용자 경험을 위한 사전 검증(미리보기 등)만 별도로 가볍게 수행한다(3장 참조).
...
| 버전 | 일자 | 변경 내용 |
|---|---|---|
| v1.0 | 2026-08-13 | 초안 작성 (2~5-user-scenario.md 기반 최상위 원칙/레이어 원칙/네이밍/테스트/설정·보안/프론트·백엔드 디렉토리 구조) |
