...
버전: v1.1 (2026-08-13)
기반 문서: `docs/2-domain-definition.md` v1.5
...
- UC-7(응모 확정)은 3장 EventApplication/PointTransaction 엔티티 갱신과 직결되며, 도메인 정의서 5.1/5.2/5.3/5.4/5.7/5.8/5.9 규칙의 적용을 받는다.
...
| 버전 | 일자 | 변경 내용 |
|---|---|---|
| v1.0 | 2026-08-13 | 초안 작성 (사용자/관리자 유스케이스 UC-1~12 다이어그램) |
| v1.1 | 2026-08-13 | UC-0(회원가입) 추가 반영, UC-2/UC-3 잘못된 include 관계 제거, docs 전체 정합성 검토 반영(버전/변경이력 절 신설, 참고란 규칙 인용에 5.4 추가) |
