...
- @docs 디렉토리의 문서들을 분석하고 실행계획(11-plan.md)의 ${TASK_NUMBER}의 내용을 분석한다.
...
- 테스트가 완료되면 실행 계획 문서의 ${TASK_NUMBER}의 완료조건 체크박스를 체크 표시한다.

## 참조 사항

- UI는 와이어프레임(8-wireframe.md)과 스타일가이드(12-style-guide.md)를 결합하여 생성한다.
